...
SELECT pg_catalog.setval('public.activity_logs_log_id_seq', 769, true);
...
SELECT pg_catalog.setval('public.employees_employee_id_seq', 29, true);
...
SELECT pg_catalog.setval('public.lock_system_lock_id_seq', 47, true);
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 1733, true);
...
SELECT pg_catalog.setval('public.notifications_notification_id_seq', 326, true);
