...
SELECT pg_catalog.setval('public.activity_logs_log_id_seq', 1041, true);
...
SELECT pg_catalog.setval('public.employees_employee_id_seq', 38, true);
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 2007, true);
...
SELECT pg_catalog.setval('public.user_user_id_seq', 58, true);
