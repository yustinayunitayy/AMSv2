...
SELECT pg_catalog.setval('public.activity_logs_log_id_seq', 1213, true);
...
SELECT pg_catalog.setval('public.employees_employee_id_seq', 54, true);
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 2204, true);
