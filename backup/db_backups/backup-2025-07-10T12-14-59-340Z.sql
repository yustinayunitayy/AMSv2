...
1	1	nblalb	nabilalb@gmail.com	$2b$12$JnBtsYTTsnhcD5tkNlT1Geo.vttLhfjPMY.Cw5IKyRxHE3bsDFDRG
\.
...
SELECT pg_catalog.setval('public.activity_logs_log_id_seq', 613, true);
...
SELECT pg_catalog.setval('public.attendance_attendance_id_seq', 297, true);
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 1486, true);
...
SELECT pg_catalog.setval('public.notifications_notification_id_seq', 271, true);
