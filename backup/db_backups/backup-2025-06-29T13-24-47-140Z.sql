...
SELECT pg_catalog.setval('public.activity_logs_log_id_seq', 571, true);
...
SELECT pg_catalog.setval('public.attendance_attendance_id_seq', 196, true);
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 1397, true);
...
SELECT pg_catalog.setval('public.notifications_notification_id_seq', 262, true);
