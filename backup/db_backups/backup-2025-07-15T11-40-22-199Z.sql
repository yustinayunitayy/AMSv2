...
28	1	personal-business	2025-07-11	2025-07-14	2025-07-15	Meeting 	Pending	\N	1
29	1	other	2025-07-11	2025-07-14	2025-07-15	Meeting	Pending	\N	1
...
SELECT pg_catalog.setval('public.activity_logs_log_id_seq', 700, true);
...
SELECT pg_catalog.setval('public.attendance_attendance_id_seq', 395, true);
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 1609, true);
...
SELECT pg_catalog.setval('public.notifications_notification_id_seq', 291, true);
...
SELECT pg_catalog.setval('public.permissions_permissions_id_seq', 30, true);
