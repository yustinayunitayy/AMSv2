...
SELECT pg_catalog.setval('public.activity_logs_log_id_seq', 828, true);
...
SELECT pg_catalog.setval('public.attendance_attendance_id_seq', 390, true);
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 1831, true);
