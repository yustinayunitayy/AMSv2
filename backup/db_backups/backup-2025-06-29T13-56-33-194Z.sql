...
205	12	2025-06-29	44803	Punch Out	20:26:43.790598	-6.4732903	106.851387	t		0.4490532758098772	20:50:57.216754	-6.4732903	106.851387	t		0.42231326242241335	t	1453	14757
\.
...
SELECT pg_catalog.setval('public.activity_logs_log_id_seq', 572, true);
...
SELECT pg_catalog.setval('public.attendance_attendance_id_seq', 205, true);
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 1399, true);
...
SELECT pg_catalog.setval('public.notifications_notification_id_seq', 263, true);
