...
310	21	Login from New Device	Login detected from IP: 127.0.0.1, Device: Opera 120.0.0	new_device	f	2025-07-24 14:31:42.360899	\N
\.
...
SELECT pg_catalog.setval('public.activity_logs_log_id_seq', 726, true);
...
SELECT pg_catalog.setval('public.attendance_attendance_id_seq', 462, true);
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 1660, true);
...
SELECT pg_catalog.setval('public.notifications_notification_id_seq', 310, true);
