...
SELECT pg_catalog.setval('public.activity_logs_log_id_seq', 576, true);
...
SELECT pg_catalog.setval('public.attendance_attendance_id_seq', 209, true);
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 1409, true);
