...
39	28	dame	gwenrosevyn@gmail.com	$2b$12$U.jTkZStT6/fsV9AZ47yIeeZ1x/uoxPD.S2VwggRjVel5K83v2odK
\.
...
SELECT pg_catalog.setval('public.activity_logs_log_id_seq', 759, true);
...
SELECT pg_catalog.setval('public.attendance_attendance_id_seq', 586, true);
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 1715, true);
