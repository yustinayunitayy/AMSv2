...
6	2	yuyusdaily	yustinayunita86@gmail.com	$2b$12$rV/3UkOrLhhI2DUdB/15S.RyP0FLydTlv4hAdcgTVPKm6DQxM63BW	2025-07-30 17:03:43.793141+00
...
SELECT pg_catalog.setval('public.activity_logs_log_id_seq', 981, true);
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 1937, true);
...
SELECT pg_catalog.setval('public.user_user_id_seq', 54, true);
