...
SELECT pg_catalog.setval('public.activity_logs_log_id_seq', 718, true);
...
SELECT pg_catalog.setval('public.attendance_attendance_id_seq', 422, true);
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 1646, true);
...
SELECT pg_catalog.setval('public.notifications_notification_id_seq', 304, true);
...
SELECT pg_catalog.setval('public.permissions_permissions_id_seq', 33, true);
