...
SELECT pg_catalog.setval('public.activity_logs_log_id_seq', 1076, true);
...
SELECT pg_catalog.setval('public.attendance_attendance_id_seq', 416, true);
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 2061, true);
...
SELECT pg_catalog.setval('public.notifications_notification_id_seq', 366, true);
