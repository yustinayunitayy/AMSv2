...
276	21	Failed Login Attempt	Detected 5 failed login attempts. Your account has been locked until 20:27:04.	failed_login	f	2025-07-10 20:22:04.657893	\N
...
31	\N	BID	anisa.n@student.president.ac.id	$2b$12$27sO1DKbfgiQPysnaBmPe.FsMfp0ylni7ruA/T9LxPzMkgVlAzFrG
30	20	Kyungsoo	anisa.nrwn15@gmail.com	$2b$12$uN7MSiQlOIxMepujMF42xO0S89ljTWi9fJo42PnehpLKAedR5vph.
...
SELECT pg_catalog.setval('public.activity_logs_log_id_seq', 682, true);
...
SELECT pg_catalog.setval('public.attendance_attendance_id_seq', 393, true);
...
SELECT pg_catalog.setval('public.lock_system_lock_id_seq', 45, true);
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 1567, true);
...
SELECT pg_catalog.setval('public.notifications_notification_id_seq', 279, true);
...
SELECT pg_catalog.setval('public.permissions_permissions_id_seq', 27, true);
