...
SELECT pg_catalog.setval('public.activity_logs_log_id_seq', 737, true);
...
SELECT pg_catalog.setval('public.attendance_attendance_id_seq', 508, true);
...
SELECT pg_catalog.setval('public.employees_employee_id_seq', 25, true);
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 1679, true);
...
SELECT pg_catalog.setval('public.notifications_notification_id_seq', 311, true);
