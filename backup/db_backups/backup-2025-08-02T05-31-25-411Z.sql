...
SELECT pg_catalog.setval('public.activity_logs_log_id_seq', 1025, true);
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 1986, true);
...
SELECT pg_catalog.setval('public.notifications_notification_id_seq', 360, true);
