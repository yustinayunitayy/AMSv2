...
4	Nabilaa	Libasutaqwa	567890098	nabila.libasutaqwa@student.president.ac.id	081223456333	UI Designer	Web Programming	\N
...
265	21	Login from New Device	Login detected from IP: 127.0.0.1, Device: Opera 119.0.0	new_device	f	2025-07-02 10:27:34.430973	\N
266	6	Login from New Device	Login detected from IP: 127.0.0.1, Device: Chrome Mobile 134.0.0	new_device	f	2025-07-04 22:16:13.439473	\N
\.
...
24	15	sick-leave	2025-06-19	2025-07-10	2025-07-12	dedede	Pending	\N	28
...
SELECT pg_catalog.setval('public.activity_logs_log_id_seq', 580, true);
...
SELECT pg_catalog.setval('public.attendance_attendance_id_seq', 224, true);
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 1418, true);
...
SELECT pg_catalog.setval('public.notifications_notification_id_seq', 266, true);
...
SELECT pg_catalog.setval('public.permissions_permissions_id_seq', 26, true);
