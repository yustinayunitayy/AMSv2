...
SELECT pg_catalog.setval('public.activity_logs_log_id_seq', 578, true);
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 1414, true);
...
SELECT pg_catalog.setval('public.notifications_notification_id_seq', 265, true);
