...
SELECT pg_catalog.setval('public.activity_logs_log_id_seq', 575, true);
...
SELECT pg_catalog.setval('public.attendance_attendance_id_seq', 207, true);
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 1407, true);
...
SELECT pg_catalog.setval('public.notifications_notification_id_seq', 264, true);
