...
SELECT pg_catalog.setval('public.activity_logs_log_id_seq', 1001, true);
...
SELECT pg_catalog.setval('public.attendance_attendance_id_seq', 407, true);
...
SELECT pg_catalog.setval('public."login_attempts_logAtt_id_seq"', 1962, true);
...
SELECT pg_catalog.setval('public.notifications_notification_id_seq', 356, true);
